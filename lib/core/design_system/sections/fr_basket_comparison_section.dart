...
class FRBasketComparisonSection extends StatelessWidget {
  const FRBasketComparisonSection({required this.title, required this.children, super.key, this.eyebrow});
