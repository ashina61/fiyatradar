...
class FRProfileIdentitySection extends StatelessWidget {
  const FRProfileIdentitySection({required this.title, required this.children, super.key, this.eyebrow});
